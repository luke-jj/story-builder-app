...
# redirect to the relevant story page if a word not set or has an invalid value
for ($i = 1; $i <= 5; $i++) {
...
echo '<h1>My Story Board</h1>';

echo '<p>There once was a(n) ' . $word1;
echo ' developer named ' . $word2;
echo '. </p>';
echo '<p>This ' .  $word3;
echo ' developer used to ' . $word4;
echo ' the ' . $word5 . '.</p>';
